    ...
    <header className="fixed inset-x-0 top-0 z-50 border-b border-[#e2e8f0] bg-[#f8fafc]/95 backdrop-blur-md">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
        ...
        <a
          ...
          className="hidden md:inline-flex items-center gap-2 bg-[#4f46e5] hover:bg-[#4338ca] text-white text-[11px] font-semibold uppercase tracking-[0.2em] px-5 py-2.5 rounded-full transition-all duration-200 shadow-sm hover:shadow-md"
        >
          Hire Me
        </a>
      </div>
